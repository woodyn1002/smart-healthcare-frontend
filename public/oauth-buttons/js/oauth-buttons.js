...
function hasClass(el, className) {
    if (el.classList) return el.classList.contains(className); else return !!el.className.match(new RegExp('(\\s|^)' +
                                                                                                           className +
                                                                                                           '(\\s|$)'));
}
...
!function (e, n, t) {
    ...
    function s() {
        ...
        for (var a in C) {
            if (C.hasOwnProperty(a)) {
                if (e = [], n = C[a], n.name && (e.push(n.name.toLowerCase()), n.options && n.options.aliases &&
                                      n.options.aliases.length)) for (t = 0; t < n.options.aliases.length; t++) {
                    e.push(n.options.aliases[t].toLowerCase());
                }
                for (s = r(n.fn, "function") ? n.fn() : n.fn, o = 0; o < e.length; o++) {
                    i = e[o], l = i.split("."), 1 === l.length ? Modernizr[l[0]] = s : (!Modernizr[l[0]] ||
                                                                                        Modernizr[l[0]] instanceof
                                                                                        Boolean ||
                                                                                        (Modernizr[l[0]] = new Boolean(Modernizr[l[0]])), Modernizr[l[0]][l[1]] = s), S.push((s ? "" : "no-") +
                                                                                                                                                                             l.join("-"));
                }
            }
        }
    ...
    function i() {
        return "function" !=
               typeof n.createElement ? n.createElement(arguments[0]) : x ? n.createElementNS.call(n, "http://www.w3.org/2000/svg", arguments[0]) : n.createElement.apply(n, arguments);
    }
    ...
    function m(e, t, r, s) {
        ...
        return o = i("style"), o.type = "text/css", o.id = "s" +
                                                           f, (c.fake ? c : p).appendChild(o), c.appendChild(p), o.styleSheet ? o.styleSheet.cssText = e : o.appendChild(n.createTextNode(e)), p.id = f, c.fake &&
                                                                                                                                                                                                         (c.style.background = "", c.style.overflow = "hidden", u = _.style.overflow, _.style.overflow = "hidden", _.appendChild(c)), l = t(p, e), c.fake ? (c.parentNode.removeChild(c), _.style.overflow = u, _.offsetHeight) : p.parentNode.removeChild(p), !!l;
    }
    ...
    function g(e, n, s, o) {
        ...
        for (d = e.length, c = 0; d > c; c++) {
            if (m = e[c], g = k.style[m], f(m, "-") && (m = u(m)), k.style[m] !== t) {
                ...
                if (k.style[m] != g) return l(), "pfx" == n ? m : !0;
            }
        }
        return l(), !1;
    }
    ...
    function y(e, n, t, s, o) {
        var i = e.charAt(0).toUpperCase() + e.slice(1),
            l = (e + " " + N.join(i + " ") + i).split(" ");
        return r(n, "string") || r(n, "undefined") ? g(l, n, s, o) : (l = (e + " " + T.join(i + " ") +
                                                                           i).split(" "), a(l, n, t));
    }
    ...
    Modernizr.prototype = w, Modernizr = new Modernizr(), Modernizr.addTest("svg", !!n.createElementNS &&
    ...
    var z = "Moz O ms Webkit",
        N = w._config.usePrefixes ? z.split(" ") : [];
    w._cssomPrefixes = N;
    var T = w._config.usePrefixes ? z.toLowerCase().split(" ") : [];
    w._domPrefixes = T;
    ...
    Modernizr._q.unshift(function () {
        ...
        var e = i("a");
        return e.style.cssText = b.join("filter:blur(2px); "), !!e.style.length &&
                                                               (n.documentMode === t || n.documentMode > 9);
    }), s(), o(S), delete w.addTest, delete w.addAsyncTest;
